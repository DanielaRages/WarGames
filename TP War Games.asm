...
xEEUU db ?  ;para guardar la base
yEEUU db ?  ;para guardar la base
xURSS db ?  ;para guardar la base
yURSS db ?  ;para guardar la base

turno db 0  ;0 = EE.UU

coordenada_x db ? ;para el disparo
coordenada_y db ? ;para el disparo
